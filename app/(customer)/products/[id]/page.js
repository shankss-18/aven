              ...
              <div className="space-y-2 text-[12px] text-[#8f8a7a]">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-1.5 bg-[#e4e0d2] rounded-full overflow-hidden">
                    <div className="h-full bg-[#e7c94a] rounded-full" style={{ width: "88%" }} />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-1.5 bg-[#e4e0d2] rounded-full overflow-hidden">
                    <div className="h-full bg-[#e7c94a] rounded-full" style={{ width: "30%" }} />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-1.5 bg-[#e4e0d2] rounded-full overflow-hidden">
                    <div className="h-full bg-[#e7c94a] rounded-full" style={{ width: "14%" }} />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-1.5 bg-[#e4e0d2] rounded-full overflow-hidden">
                    <div className="h-full bg-[#e7c94a] rounded-full" style={{ width: "4%" }} />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-1.5 bg-[#e4e0d2] rounded-full overflow-hidden">
                    <div className="h-full bg-[#e7c94a] rounded-full" style={{ width: "2%" }} />
                  </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="py-2.5 px-3.5 text-right">
                              {isCurrent ? (
                                <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-[#e7c94a]">
                                  Selected ✓
                                </span>
                              ) : isAvailable ? (
